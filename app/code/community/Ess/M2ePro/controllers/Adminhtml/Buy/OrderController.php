...
class Ess_M2ePro_Adminhtml_Buy_OrderController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    public function viewAction()
    {
        ...
        $this->_initAction()
             ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_buy_order_view'))
             ->renderLayout();
    }
    ...
    public function orderLogGridAction()
    {
        ...
        $response = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_buy_order_view_log')->toHtml();
        $this->getResponse()->setBody($response);
    }
