...
class Ess_M2ePro_Adminhtml_Amazon_Template_NewProductController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    protected function _initAction()
    {
        ...
        $this->getLayout()->getBlock('head')
            ...
            ->addJs('M2ePro/Amazon/Template/NewProduct/DescriptionHandler.js')
            ->addJs('M2ePro/Amazon/Template/NewProduct/Handler.js')
            ->addJs('M2ePro/Amazon/Template/NewProduct/SpecificHandler.js');
    ...
    public function indexAction()
    {
        ...
        $this->_initAction()
             ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_amazon_template_newProduct'))
             ->renderLayout();
    }

    public function templateNewProductGridAction()
    {
        $block = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_amazon_template_newProduct_grid');
    ...
    public function addAction()
    {
        ...
        $this->_initAction()
             ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_amazon_template_newProduct_edit'))
             ->_addLeft($this->getLayout()->createBlock('M2ePro/adminhtml_amazon_template_newProduct_edit_tabs'))
             ->renderLayout();
    }
    ...
    public function saveAction()
    {
        ...
        return $this->_redirect('*/adminhtml_amazon_template_newProduct/index',array(
    ...
    public function deleteAction()
    {
        ...
        foreach ($amazonTemplateNewProductInstances as $amazonTemplateNewProductInstance) {
            if (!$amazonTemplateNewProductInstance->deleteInstance() &&
                !$errorAlreadyDisplayed) {

                $errorMessage = count($ids) == 1
                    ? Mage::helper('M2ePro')->__('New ASIN template is locked.')
                    : Mage::helper('M2ePro')->__('Some of templates are locked.');
    ...
    public function searchCategoryAction()
    {
        ...
        $block = $this->loadLayout()->getLayout()->createBlock('M2ePro/adminhtml_amazon_template_newProduct_search_grid');
