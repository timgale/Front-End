...
class Ess_M2ePro_Adminhtml_Amazon_AccountController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    ...
    public function saveAction()
    {
        ...
        // fba
        //--------------------
        if (isset($post['magento_orders_settings']['fba_stock_mode'])) {
            $fbaStockMode = (int)$post['magento_orders_settings']['fba_stock_mode'];
            $data['magento_orders_settings']['fba_stock_mode'] = $fbaStockMode;
        }
        //--------------------
