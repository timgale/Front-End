...
UPDATE `m2epro_ebay_template_synchronization`
SET `list_mode` = 1,
    `list_status_enabled` = 0,
    `list_is_in_stock` = 0,
    `list_qty` = 0,
    `list_qty_value` = 1,
    `list_qty_value_max` = 10
WHERE (`relist_mode` = 0 OR `relist_list_mode` = 0) AND `start_auto_list` = 1;
...
SET `list_mode` = 0,
    ...
    `list_qty_value` = 1,
    `list_qty_value_max` = 10
WHERE (`relist_mode` = 0 OR `relist_list_mode` = 0) AND `start_auto_list` = 0;
