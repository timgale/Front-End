...
class Ess_M2ePro_Model_License_Model extends Ess_M2ePro_Model_Abstract
{
    ...
    {
        function filterReceivedMessages($message) {

            if (!isset($message['is_global']) || !$message['is_global']) {
                return true;
            }

            $magentoTypes = array(
                Ess_M2ePro_Model_License_Model::MESSAGE_TYPE_NOTICE =>
                    Mage_AdminNotification_Model_Inbox::SEVERITY_NOTICE,
                Ess_M2ePro_Model_License_Model::MESSAGE_TYPE_SUCCESS =>
                    Mage_AdminNotification_Model_Inbox::SEVERITY_NOTICE,
                Ess_M2ePro_Model_License_Model::MESSAGE_TYPE_WARNING =>
                    Mage_AdminNotification_Model_Inbox::SEVERITY_MINOR,
                Ess_M2ePro_Model_License_Model::MESSAGE_TYPE_ERROR =>
        ...
        $messages = array_filter($messages,'filterReceivedMessages');
