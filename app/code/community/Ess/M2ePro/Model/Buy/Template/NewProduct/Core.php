...
class Ess_M2ePro_Model_Buy_Template_NewProduct_Core extends Ess_M2ePro_Model_Component_Abstract
{
    ...
    const SELLER_SKU_MODE_CUSTOM_VALUE = 1;
    const SELLER_SKU_MODE_CUSTOM_ATTRIBUTE = 2;

    const GTIN_MODE_CUSTOM_VALUE = 1;
    const GTIN_MODE_CUSTOM_ATTRIBUTE = 2;

    const ISBN_MODE_NONE = 0;
    const ISBN_MODE_CUSTOM_VALUE = 1;
    const ISBN_MODE_CUSTOM_ATTRIBUTE = 2;

    const ASIN_MODE_NONE = 0;
    const ASIN_MODE_CUSTOM_VALUE = 1;
    ...
    public function getSellerSkuMode()
    {
        return (int)$this->getData('seller_sku_mode');
    }

    public function getSellerSkuCustomValue()
    {
        return $this->getData('seller_sku_custom_value');
    }
    ...
    public function isSellerSkuCustomValue()
    {
        return $this->getSellerSkuMode() == self::SELLER_SKU_MODE_CUSTOM_VALUE;
    }

    public function isSellerSkuCustomAttribute()
    {
        return $this->getSellerSkuMode() == self::SELLER_SKU_MODE_CUSTOM_ATTRIBUTE;
    }

    public function getSellerSkuSource()
    {
        return array(
            'mode'     => $this->getSellerSkuMode(),
            'custom_value' => $this->getSellerSkuCustomValue(),
    ...
    public function getGtinCustomValue()
    {
        return $this->getData('gtin_custom_value');
    }
    ...
    public function isGtinCustomValue()
    {
        return $this->getGtinMode() == self::GTIN_MODE_CUSTOM_VALUE;
    }
    ...
    public function getGtinSource()
    {
        return array(
            ...
            'custom_value' => $this->getGtinCustomValue(),
    ...
    public function getIsbnCustomValue()
    {
        return $this->getData('isbn_custom_value');
    }
    ...
    public function isIsbnCustomValue()
    {
        return $this->getIsbnMode() == self::ISBN_MODE_CUSTOM_VALUE;
    }
    ...
    public function getIsbnSource()
    {
        return array(
            ...
            'custom_value' => $this->getIsbnCustomValue(),
    ...
    public function getAsinCustomValue()
    {
        return $this->getData('asin_custom_value');
    }
    ...
    public function isAsinCustomValue()
    {
        return $this->getAsinMode() == self::ASIN_MODE_CUSTOM_VALUE;
    }
    ...
    public function getAsinSource()
    {
        return array(
            ...
            'custom_value' => $this->getAsinCustomValue(),
