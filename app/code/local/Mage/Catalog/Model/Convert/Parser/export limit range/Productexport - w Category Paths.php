						...
						if($row['category_ids'] != "") {
						  $finalimportofcategories = "";
							...
							foreach(explode(',',$row['category_ids']) as $productcategoryId)
							{
									...
									#$finalvcategoriesproductoptions2 = substr_replace($finalvcategoriesproductoptions2before,"",-1);
							...
							#echo "CATS: " . $okforallcategoriesnow;
							$row['categories'] = $okforallcategoriesnow;
							#$row['categories'] = $finalvcategoriesproductoptions1 . $finalvcategoriesproductoptions2 . 

substr_replace($finalvcategoriesproductoptions,"",-1);
							
							
							
						}
						#if($productitemcount <50) {
						#echo "T: ". $row['categories'] . "<br/>";
						#}
